  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <% 
			...
			out.print("<tr><th align=left>Cognome</th><th align=left>Nome</th><th align=left>Data</th> <th align=left>Luogo</th></tr>");
    		...
    		while(rs.next()){
                ...
                out.print("<tr><td>" + Cognome + "</td><td>" + Nome + "</td><td>" + Data+ "</td><td>" + Luogo + "</td><tr>");
