  ...
  <div class="row content">
    ...
    <% 
     if(request.getParameter("nome")==null || request.getParameter("nome").isEmpty()){
      %>
       <h1>Non hai inserito nessun <%= request.getParameter("nome") %> </h1>
      <%
        return;
      } 
      %>
     ...
     if(request.getParameter("cognome")==null || request.getParameter("cognome").isEmpty()){
      ...
      %>
        ...
        <% 
			...
			String sql = "SELECT * FROM Cantante where Cognome = ? and Nome = ?";
			
			PreparedStatement stmt = connection.prepareStatement(sql);
			
			stmt.setString(1, request.getParameter("cognome"));
    		...
    		while(rs.next()){
               ...
               int ID = rs.getInt("ID");
			    ...
			    if(Data  != null ){
		          ...
		          out.print("Data di nascita: " + Data +"<br>");
		        }
		        
		        if(Luogo  != null ){
		          
		          out.print("Luogo di nascita: " + Luogo +"<br>");
		        }
